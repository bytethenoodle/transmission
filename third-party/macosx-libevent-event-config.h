...
/* #undef EVENT__HAVE_SYSEVENT_FD_H */

/* Define to 1 if you have the <sys/event.h> header file. */
#define EVENT__HAVE_SYSEVENT__H 1
...
#define EVENT__NUMERIC_VERSION 0x02000b01
...
#define EVENT__VERSION "2.0.11-stable-dev"
